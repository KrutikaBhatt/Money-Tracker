...
import './index.css'
import split from './divide-money-bg.png'
...
export default function Login() {
  ...
  return (
    <>
            ...
            <img src={split} alt="loading..." style={{height:'80%',width:'50%',position:'absolute',backgroundColor:'#eee8f4',margin:'30px',marginTop:'60px'}} />
            </div>
            <div className='login-s'>
            <p className='login-head'>Money<span style={{color:'#674fa3'}}>Tracker</span></p>
